...
public class MotionDesign extends Command {
    public MotionDesign(String name){
        super(name);
    }
    ...
    public void exec(Message message) {
        ...
        CommandManager.setCommandType(id, "Motion");
        CommandManager.setCommandPlatform(id, "Дизайн");
    }

    private String text(){
        String text = "Выбранная сфера дизайна: Motion\n\n" +
